...
export default () => (
  <Layout title="Datenschutz">
    <div style={{width: '20%', float: 'right', margin: '0 0 15px 15px'}}>
      <Image src="legal.png" />
    </div>
    <h2>Datenschutz</h2>
    ...
    sehr ernst. Eine Nutzung unserer Internetseiten ist grundsätzlich ohne
    jede Angabe personenbezogener Daten möglich. Sofern eine betroffene Person
    besondere Services über unsere Internetseite in Anspruch nehmen möchte,
    ...
    die Betreiber generell eine Einwilligung der betroffenen Person ein.</p>
    ...
    Datenschutzbestimmungen. Mittels dieser Datenschutzerklärung möchten die
    Betreiber die Öffentlichkeit über Art, Umfang und Zweck der von uns
    ...
    <p>Wir haben als für die Verarbeitung Verantwortliche zahlreiche
    ...
    <p>Diese Datenschutzerklärung beruht auf den Begrifflichkeiten, die durch
    ...
    <ul style={{listStyle: 'none'}}>
      ...
      <li><h4>g)&nbsp;&nbsp;&nbsp; Verantwortlicher oder für die Verarbeitung
      Verantwortlicher</h4>
    ...
    den Mitgliedstaaten der Europäischen Union geltenden Datenschutzgesetze
      und anderer Bestimmungen mit datenschutzrechtlichem Charakter ist:</p>

    <p style={{fontSize: '1.5rem', lineHeight: '2rem'}}>
        Elias Kuiter<br />
        Kunkenvenne 3<br />
        49832 Thuine<br />
        <a href="mailto:info@elias-kuiter.de">info@elias-kuiter.de</a>
    </p>

    <h4>3. Cookies</h4>
    <p>Unsere Internetseiten verwenden Cookies. Cookies sind Textdateien,
    ...
    <p>Durch den Einsatz von Cookies können die Betreiber den Nutzern dieser
    ...
    <p>Unsere Internetseite erfasst mit jedem Aufruf der Internetseite durch
    ...
    Internet-Protokoll-Adresse (IP-Adresse), (7) der Internet-Service-Provider
    des zugreifenden Systems und (8) sonstige ähnliche Daten und
    Informationen, die der Gefahrenabwehr im Falle von Angriffen auf unsere
    informationstechnologischen Systeme dienen.</p>

    <p>Bei der Nutzung dieser allgemeinen Daten und Informationen ziehen die
    ...
    erhobenen Daten und Informationen werden durch die Betreiber daher
    einerseits statistisch und ferner mit dem Ziel ausgewertet, den
    Datenschutz und die Datensicherheit zu erhöhen, um letztlich ein optimales
    ...
    <p>Unsere Internetseite enthält aufgrund von gesetzlichen Vorschriften Angaben, die eine schnelle
    ...
    <h4>6. Routinemäßige Löschung und Sperrung von personenbezogenen
    Daten</h4>
    ...
    <ul style={{listStyle: 'none'}}>
      <li><h4>a)&nbsp;&nbsp;&nbsp; Recht auf Bestätigung</h4>
        ...
        sie sich hierzu jederzeit an die Betreiber wenden.</p>
      </li>
      <li><h4>b)&nbsp;&nbsp;&nbsp; Recht auf Auskunft</h4>
        ...
        nehmen, kann sie sich hierzu jederzeit an die Betreiber wenden.</p>
      </li>
      <li><h4>c)&nbsp;&nbsp;&nbsp; Recht auf Berichtigung</h4>
        ...
        nehmen, kann sie sich hierzu jederzeit an die Betreiber wenden.</p></li>
      <li>
        ...
        <ul style={{listStyle: 'none'}}>
          ...
          die Verarbeitung gemäß Art. 6 Abs. 1 Buchstabe a DS-GVO oder Art. 9
        ...
        Person die Löschung von personenbezogenen Daten, die bei den
        Betreibern gespeichert sind, veranlassen möchte, kann sie sich hierzu
        jederzeit an die Betreiber wenden. Wir werden veranlassen, dass dem
        Löschverlangen unverzüglich nachgekommen wird.</p>

        <p>Wurden die personenbezogenen Daten von den Betreibern öffentlich
        gemacht und sind die Betreiber als Verantwortlicher gemäß Art. 17 Abs.
        1 DS-GVO zur Löschung der personenbezogenen Daten verpflichtet, so
        treffen die Betreiber unter Berücksichtigung der verfügbaren
        ...
        die Verarbeitung nicht erforderlich ist. Die Betreiber werden im
      ...
      <li><h4>e)&nbsp;&nbsp;&nbsp; Recht auf Einschränkung der Verarbeitung</h4>
        ...
        <ul style={{listStyle: 'none'}}>
          ...
          ob die berechtigten Gründe des Verantwortlichen gegenüber denen der
        ...
        bei den Betreibern gespeichert sind, verlangen möchte, kann sie sich
        hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
        Verantwortlichen wenden. Die Betreiber werden die Einschränkung der
      ...
      <li><h4>f)&nbsp;&nbsp;&nbsp;&nbsp; Recht auf Datenübertragbarkeit</h4>
        ...
        die betroffene Person jederzeit an die Betreiber wenden.</p>
      ...
      <li>
        ...
        <p>Die Betreiber verarbeiten die personenbezogenen Daten im Falle
        ...
        <p>Verarbeiten die Betreiber personenbezogene Daten, um Direktwerbung
        ...
        Widerspricht die betroffene Person gegenüber den Betreibern der
        Verarbeitung für Zwecke der Direktwerbung, so werden die Betreiber die
        ...
        Verarbeitung personenbezogener Daten, die bei den Betreibern zu
        ...
        Person direkt an die Betreiber wenden. Der betroffenen Person steht es
      ...
      Profiling</h4>
        ...
        betroffenen Person, treffen die Betreiber angemessene Maßnahmen, um
      ...
      <li><h4>i)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Recht auf Widerruf einer datenschutzrechtlichen
      Einwilligung</h4>
        <p>Jede von der Verarbeitung personenbezogener Daten betroffene Person
        hat das vom Europäischen Richtlinien- und Verordnungsgeber gewährte
    ...
    <p>Ferner besteht für die betroffene Person die Möglichkeit, einer Erfassung der durch Google Analytics erzeugten, auf eine Nutzung dieser Internetseite bezogenen Daten sowie der Verarbeitung dieser Daten durch Google zu widersprechen und eine solche zu verhindern. Hierzu muss die betroffene Person ein Browser-Add-On unter <a href="https://tools.google.com/dlpage/gaoptout">diesem Link</a> herunterladen und installieren. Dieses Browser-Add-On teilt Google Analytics über JavaScript mit, dass keine Daten und Informationen zu den Besuchen von Internetseiten an Google Analytics übermittelt werden dürfen. Die Installation des Browser-Add-Ons wird von Google als Widerspruch gewertet. Wird das informationstechnologische System der betroffenen Person zu einem späteren Zeitpunkt gelöscht, formatiert oder neu installiert, muss durch die betroffene Person eine erneute Installation des Browser-Add-Ons erfolgen, um Google Analytics zu deaktivieren. Sofern das Browser-Add-On durch die betroffene Person oder einer anderen Person, die ihrem Machtbereich zuzurechnen ist, deinstalliert oder deaktiviert wird, besteht die Möglichkeit der Neuinstallation oder der erneuten Aktivierung des Browser-Add-Ons.</p>

    <p>Weitere Informationen und die geltenden Datenschutzbestimmungen von Google können unter <a href="https://www.google.de/intl/de/policies/privacy/">diesem</a> und <a href="http://www.google.com/analytics/terms/de.html">diesem</a> Link abgerufen werden. Google Analytics wird unter <a href="https://www.google.com/intl/de_de/analytics/">diesem Link</a> genauer erläutert.</p>

    <h4>9. Rechtsgrundlage der Verarbeitung</h4>
    <p>Art. 6 I lit. a DS-GVO dient den Betreibern als Rechtsgrundlage für
      ...
      Fällen von Anfragen zur unseren Produkten oder Leistungen. Unterliegen
      die Betreiber einer rechtlichen Verpflichtung durch welche eine
      ...
      Interesses der Betreiber oder eines Dritten erforderlich ist,
    ...
    <h4>10. Berechtigte Interessen an der Verarbeitung, die von dem
    ...
    <h4>12. Gesetzliche oder vertragliche Vorschriften zur Bereitstellung der
    ...
    <p>Wir klären Sie darüber auf, dass die Bereitstellung personenbezogener
      ...
      personenbezogene Daten bereitzustellen, wenn die Betreiber mit ihr
      einen Vertrag abschließen. Eine Nichtbereitstellung der personenbezogenen
    ...
    <p>Als verantwortungsbewusste Seitenbetreiber verzichten wir auf eine
    ...
    als <a href="https://dg-datenschutz.de/datenschutz-dienstleistungen/externer-datenschutzbeauftragter/" rel="nofollow">Externer Datenschutzbeauftragter Dresden</a> tätig ist, in
    Kooperation mit dem <a href="https://www.wbs-law.de/" rel="nofollow">Rechtsanwalt für Datenschutzrecht</a> Christian Solmecke
    erstellt.
    </p>
  </Layout>
);